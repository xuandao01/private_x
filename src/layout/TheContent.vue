  ...
  <div class="content">
    ...
    <div class="content-header">
      ...
      <div class="content-button">
        ...
        <button class="btn-add" @click="this.showNewPopup()" id="add_employee">
...
<script>
import EmployeeDetail from "../components/unit-components/MEmployeeDetail.vue";
// import MEmployeeLoading from "../components/unit-components/MEmployeeLoading.vue";
import MToastItem from "../components/base-component/MToastItem.vue";
import MDeleteConfirmDialog from "../components/unit-components/MConfirmDeleteDialog.vue";
import MEmployeeList from '@/components/unit-components/MEmployeeList.vue';
